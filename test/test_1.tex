...
\includegraphics{https://i.imgur.com/pRjwIFX.png} \textbf{Figure 1.1:}
3D geometry of flow over weir

\includegraphics{https://i.imgur.com/Nc2BAlC.png} \textbf{Figure 1.2:}
Cross section view

\includegraphics{https://i.imgur.com/6cr53dC.png} \textbf{Figure 1.3:}
...
\includegraphics{https://i.imgur.com/8Iy9t9a.jpg} \textbf{Figure 2.1:}
...
\includegraphics{https://i.imgur.com/x8nHqPb.jpg} \textbf{Figure 2.2:}
...
\includegraphics{https://i.imgur.com/WNk7ODQ.jpg} \textbf{Figure 2.3:}
...
\includegraphics{https://i.imgur.com/TfVnBSm.png} \textbf{Figure 3.1 A:}
Velocity profile diagram under laminar conditions with height of stream
over weir = \(0\ m\)

\includegraphics{https://i.imgur.com/TrzWFZM.png} \textbf{Figure 3.1 B:}
...
\includegraphics{https://i.imgur.com/IwHVfdK.png} \textbf{Figure 3.2 A:}
Velocity profile diagram under turbulent conditions with height of
stream over weir = \(0\ m\)

\includegraphics{https://i.imgur.com/rgntgsR.png} \textbf{Figure 3.2 B:}
...
\includegraphics{https://i.imgur.com/RPezIb6.png} \textbf{Figure 4.1 A:}
Velocity profile diagram under laminar conditions with height of stream
over weir = \(0.5\ m\)

\includegraphics{https://i.imgur.com/OwP5FLW.png} \textbf{Figure 4.1 B:}
Pressure field diagram under laminar conditions with height of stream
over weir = \(0.5\ m\)
...
\includegraphics{https://i.imgur.com/DDlopKq.png} \textbf{Figure 4.2 A:}
Velocity profile diagram under turbulent conditions with height of
stream over weir = \(0.5\ m\)

\includegraphics{https://i.imgur.com/k6HkEo7.png} \textbf{Figure 4.2 B:}
Pressure field diagram under turbulent conditions with height of stream
over weir = \(0.5\ m\)
...
\includegraphics{https://i.imgur.com/ZiofUM4.png} \textbf{Figure 5.1 A:}
Velocity profile diagram under laminar conditions with height of stream
over weir = \(1\ m\)

\includegraphics{https://i.imgur.com/yKVkgDz.png} \textbf{Figure 5.1 B:}
Pressure field diagram under laminar conditions with height of stream
over weir = \(1\ m\)
...
\includegraphics{https://i.imgur.com/Sk4lOdu.png} \textbf{Figure 5.2 A:}
Velocity profile diagram under turbulent conditions with height of
stream over weir = \(1\ m\)

\includegraphics{https://i.imgur.com/UcJ6Rvk.png} \textbf{Figure 5.2 B:}
Pressure field diagram under turbulent conditions with height of stream
over weir = \(1\ m\)
